...
void AJoint::updateTransform()
{
	...
	/*
	std::cout << "This Joint ID:" << this->mId << std::endl;
	std::cout << "This Joint's Local Translation:" << std::endl << this->mLocal2Parent.m_translation << std::endl;
	std::cout << "This Joint's Local Rotation:" << std::endl << this->mLocal2Parent.m_rotation << std::endl;
	std::cout << "This Joint's parent2Global Translation:" << std::endl << this->mLocal2Global.m_translation << std::endl;
	std::cout << "This Joint's parent2Global Rotation:" << std::endl << this->mLocal2Global.m_rotation << std::endl;
	*/
	//ATransform mParent2Global = mLocal2Global;
	ATransform mParent2Global = this->getParent()->getLocal2Global();
	mLocal2Global = mParent2Global * mLocal2Parent;
	/*
	std::cout << "This Joint's local2Global Translation:" << std::endl << this->mLocal2Global.m_translation << std::endl;
	std::cout << "This Joint's local2Global Rotation:" << std::endl << this->mLocal2Global.m_rotation << std::endl;
	...
	*/
	...
	{
		mChildren.at(i)->updateTransform();
	}
